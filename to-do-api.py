...
app.config['MYSQL_DATABASE_HOST'] = 'database' # Dockerfile ile oluşturulacak container içerindeki database'in ismi yani host name.
app.config['MYSQL_DATABASE_DB'] = 'todo_db'   # container içerinde oluşturulacak database'in ismi.
